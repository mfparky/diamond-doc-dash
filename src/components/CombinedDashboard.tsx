...
import { GameByGameChart } from '@/components/GameByGameChart';
...
const EVENT_COLORS: Record<string, string> = {
  'Bullpen': 'hsl(var(--chart-3))',
  'Game': 'hsl(var(--status-active))',
  'External': 'hsl(var(--chart-4))',
  'Live ABs': 'hsl(var(--status-warning))',
};
    ...
    <div className="space-y-6 animate-slide-up overflow-x-hidden">
      ...
      {!parentMode && gamesStats.games.length > 0 && (
        <section className="space-y-3">
          ...
          <GameByGameChart games={gamesStats.gameSummaries} />
