...
export function PitcherDetail({ pitcher, onBack, onUpdateOuting, onDeleteOuting, onAddOuting }: PitcherDetailProps) {
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      {/* Stats Grid */}
      {(() => {
        const allOutings = pitcher.outings;
        const totalPitches = allOutings.reduce((sum, o) => sum + o.pitchCount, 0);
        const outingsWithStrikes = allOutings.filter(o => o.strikes !== null);
