...
export function Header({ viewMode, onViewModeChange, onAddOuting }: HeaderProps) {
  return (
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-xl text-foreground">Pitching Hub</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center bg-secondary rounded-lg p-1">
              <Button
                variant="ghost"
                size="sm"
                className={viewMode === 'cards' ? 'bg-card shadow-sm' : ''}
