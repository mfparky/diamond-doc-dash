    ...
    >
      <CardContent className="p-4">
        ...
        <Tabs defaultValue="stats" className="w-full">
          ...
          <TabsContent value="stats" className="mt-3" onClick={onClick}>
          ...
          <TabsContent value="notes" className="mt-3 space-y-3">
            <div>
              <p className="text-xs text-muted-foreground font-medium mb-1">Focus:</p>
              <p className="text-sm text-foreground">{pitcher.focus || 'No focus set'}</p>
            </div>
            
            <div className="border-t border-border/50 pt-3">
              <p className="text-xs text-muted-foreground font-medium mb-1">Recent Feedback:</p>
              <p className="text-sm text-foreground">{pitcher.notes || 'No notes yet'}</p>
            </div>
          </TabsContent>
        </Tabs>
      </CardContent>
